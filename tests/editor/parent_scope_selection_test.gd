...
func _test_scanner_reads_selectable_as_parent() -> void:
	...
	var scene := TscnScanner.scan(
			&"res://tests/fixtures/scopes/selectable_scope.tscn"
	)
...
func _test_scanner_defaults_missing_property_to_false() -> void:
	...
	var scene := TscnScanner.scan(&"res://tests/fixtures/scopes/basic_scope.tscn")
...
func _scope(scope_id: StringName, selectable: bool) -> TestContainerScope:
